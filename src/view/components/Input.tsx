...
export const Input = forwardRef<HTMLInputElement, InputProps>(
    ...
    return(
        <div className="relative">
            ...
            placeholder=" "
            className={cn(
                'bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 pt-4 placeholder-shown:pt-0  peer focus:border-gray-800 outline-none transition-all',
